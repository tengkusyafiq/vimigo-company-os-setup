...
**Mac** — right-click `Setup-Mac.command`, then choose **Open**

On a Mac you must right-click the first time. Double-clicking will not work
until you have done that once. That is your Mac being careful, not a fault.
...
- type a short code into WhatsApp on your phone
